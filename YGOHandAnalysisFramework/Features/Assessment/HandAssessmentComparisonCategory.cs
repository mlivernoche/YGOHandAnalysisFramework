...
internal sealed class HandAssessmentComparisonCategory<TCardGroup, TCardGroupName, TReturn, TAssessment> : DataComparisonCategoryBase<HandAnalyzer<TCardGroup, TCardGroupName>, TReturn>
    ...
    where TAssessment : IHandAssessment<TCardGroupName>
{
    ...
    public HandAssessmentComparisonCategory(
        string name,
